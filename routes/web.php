...
//Route::get('/messages', [AdminController::class, 'showMessages'])->name('messages');
Route::middleware(['auth', 'admin'])->get('/messages', [AdminController::class, 'showMessages'])->name('messages');
...
Route::post('/stripe/create-payment-intent', [HomeController::class, 'createPaymentIntent']);
